package com.example.modul4xml.ui.adapter
...
import com.example.modul4xml.databinding.ItemCardBinding
...
class CardAdapter(
    ...
    private val data: MutableList<ContentCard> = mutableListOf()
    ...
    fun updateData(items: List<ContentCard>) {
        data.clear()
        data.addAll(items)
